"""
#first
go back to ussd code assignment 
make the modifications 
use functions 
make use of whole loop
write code in a unified way that it wont be too much"""
def home():
    print('Welcome! What operation would you like to perform')
